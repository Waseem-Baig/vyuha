    ...
    useEffect(() => {
        const createParticles = () => {
            ...
            for (let i = 0; i < 20; i++) {
                ...
                // Add different colors like in other components
        ...
        <section className="relative py-24 overflow-hidden">
            ...
            >
                ...
                >
                    ...
                    >
                        Hear from those who have experienced the impact of our work and innovation.
                    </motion.p>
                </motion.div>
                                ...
                                {testimonials.map((testimonial, index) => (
                                    <motion.div
                                        ...
                                        initial={{
                                            opacity: 0,
                                            scale: 0.9,
                                            rotateY: Math.floor(Math.random() * 21) - 10,
                                        }}
                                        animate={{
                                            opacity: isActive(index) ? 1 : 0,
                                            scale: isActive(index) ? 1 : 0.95,
                                            rotateY: isActive(index) ? 0 : Math.floor(Math.random() * 21) - 10,
